					...
					<?php if(esc_attr($field['mapster-draw-type-point']) == 1) { ?>
						...
						<div>
							<div class="point-inputs">
								<input id="mapster-map-point-longitude" type="text" placeholder="Longitude" />
								<input id="mapster-map-point-latitude" type="text" placeholder="Latitude" />
							</div>
							<div id="set-manual-point" class="button button-primary">Set Point</div>
						</div>
					<?php } ?>
