...
class Mapster_Wordpress_Maps {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_head-edit.php', $plugin_admin, 'mapster_add_user_submission' );
		...
		$this->loader->add_action('rest_api_init', $custom_endpoints, 'mapster_wp_maps_frontend_submission');

		$this->loader->add_action( 'admin_notices', $plugin_admin, 'mapster_wp_maps_admin_notice' );

		$this->loader->add_action( 'acf/prepare_field', $plugin_admin, 'mapster_wp_maps_determine_field_visibility');
	}
